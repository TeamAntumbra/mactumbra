...
{
    [_popoverController.contentViewController mouseDown:theEvent];

}

-(void)mouseDragged:(NSEvent *)theEvent
{
    [_popoverController.contentViewController mouseDragged:theEvent];
}
-(void)mouseUp:(NSEvent *)theEvent
{
    [_popoverController.contentViewController mouseUp:theEvent];
}
